...
| `src/MailAggregator.Desktop/MainWindow.xaml.cs` | [main-viewmodel.md](main-viewmodel.md) | Main window code-behind: WebView2 email + AI markdown preview, folder tree, minimize-to-tray |
...
| `src/MailAggregator.Desktop/ViewModels/MainViewModel.Ai.cs` | [main-viewmodel.md](main-viewmodel.md) | Central VM partial: AI translate/summarize commands, AiMarkdown property, settings launcher |
...
| `src/MailAggregator.Desktop/ViewModels/AiSettingsViewModel.cs` | [main-viewmodel.md](main-viewmodel.md) | AI settings dialog VM: base URL, key (PasswordBox), model, language, prompts |
...
| `src/MailAggregator.Desktop/Views/AiSettingsWindow.xaml.cs` | [main-viewmodel.md](main-viewmodel.md) | Code-behind: wires `CloseRequested`, binds PasswordBox to API key, calls `LoadAsync` |
